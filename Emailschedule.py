...
def mail():
    ...
    smtp.login('noorshaikh2188@gmail.com', 'nooralam@123')
  
    # Call the message function
    msg = message("Good!", "Hi there!")
      
    # Make a list of emails, where you wanna send mail
    to = ["nooralam.shaikh@neebal.com"]
  
    # Provide some data to the sendmail function!
    smtp.sendmail(from_addr="noorshaikh2188@gmail.com",
...
schedule.every().friday.at("12:20").do(mail)
